				...
				<div class="m-portlet__head">
					...
					<div class="m-portlet__head-tools">
						<ul class="m-portlet__nav">
							...
							<li class="m-portlet__nav-item">
								<a href="ManajemenKelas/KelolaKelas?IDKelas=<?= $kelas->idKelas ?>" class="m-portlet__nav-link m-portlet__nav-link--icon" 
				        	...
				        	<?php foreach ($this->ManajemenKelas_m->getPesdik($kelas->idKelas) as $pd): ?>
					        	<div class="m-widget3__item">
					                <div class="m-widget3__header">
					                    ...
					                    <a href="#" class="m-widget3__status m--font-danger">
					                        Keluarkan
					                    </a>
					                </div>
					            </div>
