...
<?php foreach ($kelompokMapel as $listKelompok): ?>
	...
	<?php foreach ($mapel as $listMapel): ?>
		...
		<td style="width: 12.0419%; height: 18px; text-align: center;"><?= predikatNilai($kkmPengetahuan, $nilaiPengetahuan) ?></td>
		...
		<td style="width: 12.1902%; height: 18px; text-align: center;"><?= predikatNilai($kkmKeterampilan, $nilaiKeterampilan) ?></td>
		</tr>
	<?php endforeach ?>
<?php endforeach ?>
