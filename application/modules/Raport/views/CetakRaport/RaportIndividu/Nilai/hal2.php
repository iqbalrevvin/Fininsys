...
<table style="border-collapse: collapse; width: 100%; height: 72px;" border="1">
	<tbody>
		...
		<td style="width: 47.1739%; height: 36px; text-align: center;" rowspan="2"><strong>Mata Pelajaran</strong></td>
		<td style="width: 47.2283%; text-align: center; height: 18px;" colspan="3"><strong>Nilai Prilaku</strong></td>
		</tr>
		<tr style="height: 18px; background-color: #dec349;">
		<td style="width: 18.4602%; text-align: center; height: 18px;"><strong>Sikap</strong></td>
		<td style="width: 15.0181%; text-align: center; height: 18px;"><strong>Sosial</strong></td>
		...
		<?php foreach ($kelompokMapel as $listKelompok): ?>
			...
			<?php foreach ($mapel as $listMapel): ?>
				<tr style="height: 18px;">
					...
					<td style="width: 47.1739%; height: 18px;"><?= $listMapel->nama_mata_pelajaran ?></td>
					<td style="width: 18.4602%; height: 18px; text-align: center;"><?= $listMapel->nilai_sikap ?></td>
					<td style="width: 15.0181%; height: 18px; text-align: center;"><?= $listMapel->nilai_sosial ?></td>
