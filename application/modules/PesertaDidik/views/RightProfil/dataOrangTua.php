<div class="m-portlet__body">
	<form class="m-form m-form--fit m-form--label-align-right">
		...
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				<label>NIK Ibu :</label>
				<a href="#" class="NIKIbu" id="2" data-type="number" data-placement="left" 
					data-title="NIK Ibu" data-name="NIK_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->NIK_ibu ?>
	  			</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				...
				<a href="#" class="namaIbu" id="2" data-type="text" data-placement="left" 
					data-title="Nama Ibu" data-name="nama_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->nama_ibu ?>
	  			</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				...
				<a href="#" class="tahunLahirIbu" id="2" data-type="number" data-placement="left" 
					data-title="Tahun Lahir Ibu" data-name="tahun_lahir_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->tahun_lahir_ibu ?>
	  			</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				...
				<a href="#" class="pendidikanIbu" id="2" data-type="select" data-placement="left" 
					data-title="Pendidikan Ibu" data-name="pendidikan_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->pendidikan_ibu ?>
	  			</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				...
				<a href="#" class="pekerjaanIbu" id="2" data-type="select" data-placement="left" 
					data-title="Pekerjaan Ibu" data-name="pekerjaan_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->pekerjaan_ibu ?>
	  			</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12 col-sm-12 col-lg-10">
				...
				<a href="#" class="penghasilanAyah" id="2" data-type="select" data-placement="left" 
					data-title="Penghasilan Ibu" data-name="penghasilan_ibu" data-pk='<?= $profil->NIK_pd ?>'>
	    			<?= $profil->penghasilan_ibu ?>
	  			</a>
			</div>
		</div>
	</form>						
...
<script>
    ...
    $('.pekerjaanAyah').editable({
        ...
        source: [
        	...
        	{value: "PNS", text: "PNS"},
        	{value: "Karyawan Swasta", text: "Karyawan Swasta"},
        	{value: "Wiraswasta", text: "Wiraswasta"},
        	{value: "PNS/TNI/Polri", text: "PNS/TNI/Polri"},
        	{value: "Tenaga Pendidik", text: "Tenaga Pendidik"},
        	{value: "Petani", text: "Petani"},
        	{value: "Peternak", text: "Peternak"},
        	{value: "Sudah Meninggal", text: "Sudah Meninggal"},
        	{value: "Tenaga Kerja Indonesia", text: "Tenaga Kerja Indonesia"},
        	{value: "Tidak Bekerja", text: "Tidak Bekerja"},
        ],
        emptytext: 'Kosong',
        title: 'Enter Value',
        url : '<?= base_url('PesertaDidik/Profil/editOrangTua') ?>',
