		...
		<div class="m-portlet__body">
			<div class="m-card-profile">
				...
				<div class="m-card-profile__details">
					...
					<span class="m-card "><b>Tingkat  <?= grade($profil->tahun_angkatan, $profil->jumlah_semester) ?></a></b> | 
					<span class="m-card "><b>Semester  <?= semester($profil->tahun_angkatan, $profil->jumlah_semester) ?></a></b><br>
					<span class="m-card "><b><?= valueCekKelas($profil->nama_kelas) ?></b></a>
